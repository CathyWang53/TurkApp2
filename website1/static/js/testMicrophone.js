...
function afterEndRcd(){
  if(!noteContent.length) {
   instructions.html('<h5 style="color:red;"> We could not recognize your voice. </h5> <h6>Please check if you have granted the permission to the microphone and your microphone works well. </h6>');
   ...
   $('#recording-instructions').show();
    ...
    $('#speak').html('Speak Again');
    $('#speak').show();
    //$('#recording-title').html('<h5>You have passed the Microphone test. You can also speak again if you would like. </h5>');
    instructions.html('<h5 style="color:green;">You have passed the Microphone test.</h5> <h6> You can speak again if you would like to, or click "Next" to continue when you are ready. </h6>');
    instructions.show();
    $('#operation').hide();
